...
# https://github.com/TRI-ML/packnet-sfm/blob/c03e4bf929f202ff67819340135c53778d36047f/packnet_sfm/networks/pose/PoseNet.py
...
class PoseNet(nn.Module):
    ...
    def forward(self, image, context):
        ...
        pose = 0.0015 * pose.view(pose.size(0), self.nb_ref_imgs, 6)
        pose[:, :, :3] = 0 
